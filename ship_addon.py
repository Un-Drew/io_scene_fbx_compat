...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Script to build io_scene_fbx_compat.zip, usable as both an extension,"
                                                 " and in the case of older Blenders, as a legacy addon")
    ...
    output_filename = os.path.join("out", "io_scene_fbx_compat")
    make(addon_dir="io_scene_fbx_compat", output_zip_filename_without_ext=output_filename)
    returncode = 1
    try:
